...
var api = module.exports = {
    ...
    setFlows: function(opts) {
        return new Promise(function(resolve,reject) {
            ...
            if (deploymentType === 'reload') {
                ...
                apiPromise = runtime.flows.setFlows(flows.flows,flows.credentials,deploymentType);
            }
    ...
    */
    addFlow: function(opts) {
        return new Promise(function(resolve,reject) {
            var flow = opts.flow;
            runtime.flows.addFlow(flow).then(function(id) {
    ...
    */
    updateFlow: function(opts) {
        return new Promise(function (resolve,reject) {
            ...
            var id = opts.id;
            try {
                runtime.flows.updateFlow(id,flow).then(function() {
    ...
    */
    deleteFlow: function(opts) {
        return new Promise(function (resolve,reject) {
            var id = opts.id;
            try {
                runtime.flows.removeFlow(id).then(function() {
